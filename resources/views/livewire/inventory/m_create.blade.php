...
<div class="bg-gray-800 rounded-lg mb-1 shadow-xl w-full max-w-full px-2 sm:px-8 mx-auto">
            ...
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <p class="text-white font-medium text-sm">Error al crear:</p>
                    </div>
        ...
        <div class="p-3 mb-3 bg-red-600 border border-red-500 rounded-lg">
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    ...
                    <ul class="text-red-100 text-xs list-disc list-inside">
    ...
    {{-- ======================= INICIO: Formulario de Creación Móvil ======================= --}}
    <form wire:submit.prevent="saveInventory" class="p-3 sm:p-6 space-y-4">
        {{-- ======================= INICIO: Información básica móvil ======================= --}}
        <div class="bg-gray-700 rounded-lg p-3">
            <h4 class="text-white font-medium mb-3 text-sm">📅 Información Básica</h4>
            <div class="space-y-3">
                ...
                <div>
                    ...
                    <input wire:model="dir" type="text"
            ...
            <div class="space-y-3">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input wire:model="articulo" type="text"
                            class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
            ...
            <div class="space-y-3">
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div>
                        ...
                        <input wire:model="apa" type="text"
                            class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                            placeholder="APA">
                        @error('apa')
                            <span class="text-red-400 text-xs">{{ $message }}</span>
                    ...
                    <div>
                        ...
                        <input wire:model="ama" type="text"
                            class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                            placeholder="AMA">
                        @error('ama')
                            <span class="text-red-400 text-xs">{{ $message }}</span>
                ...
                <div>
                    ...
                    <textarea wire:model="software_instalado" rows="3"
                        class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
                ...
                <div>
                    ...
                    <textarea wire:model="info_pc" rows="3"
                        class="w-full px-3 py-2 bg-gray-700 border border-gray-600 rounded-lg text-white placeholder-gray-400 focus:ring-2 focus:ring-blue-500 focus:border-transparent text-sm"
    ...
    {{-- ======================= FIN: Formulario de Creación Móvil ======================= --}}
