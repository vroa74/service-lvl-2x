            ...
            <div class="flex items-start justify-between">
                <div class="flex-1">
                    <div class="flex items-center gap-2 mb-2">
                        ...
                        <p class="text-white font-medium">Error al guardar el inventario:</p>
                    </div>
    ...
    <form wire:submit.prevent="saveInventory" class="p-6 space-y-6">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
                ...
                <input wire:model="resguardante_edit" type="text" id="resguardante_edit"
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
                ...
                <input wire:model.live="articulo" type="text" id="articulo"
            ...
            <div>
                ...
                <input wire:model.live="type" type="text" id="type"
