...
class Create_tem extends Component
{
    use WithFileUploads;
...
.";
    ...
    public function selectInventory($inventoryId)
    {
        ...
        if ($this->inventoryModalType === 'objetivo') {
            $info = "INVENTARIO: TYPE: {$inventory->type}, Marca: {$inventory->marca}, Modelo: {$inventory->modelo}, Artículo: {$inventory->articulo}, NI: {$inventory->ni}, SN: {$inventory->ns}. ";
    ...
    public function addPhoto()
    {
        ...
        Log::info('Foto guardada físicamente', [
            'path' => $path,
