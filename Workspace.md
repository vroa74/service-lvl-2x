...
========================================================================================================
   necesito crear un una migraciones para este proyecto de laravel ayudame a crear las migraciones, quiro inicia con solo las migraciones
   Migracion  Auditoria.
    id          INTEGER -- llava auto incremental
    iduser      INTEGER -- llave foranea  de migracion user puede ser nula                             
    idres       INTEGER -- llave foranea  de migracion user 
    idoic       INTEGER -- llave foranea  de migracion user 
    idinfo      INTEGER -- llave foranea  de migracion user 
    id_aud_list VARCHAR (64) --esta es una vampo llave unico que enlasa con otra migracion
    FH          DATETIME     --este campo es DateTime
    ni          INTEGER    -- esta es una llave foranea de la tabla inventories
    PCDetalle   TEXT,      -- estes es un campo de detalles para uso discrecional del usuario


    Migracion: detalles_autitoria
      id          INTEGER -- entero autoincremental
    id_aud_list VARCHAR -- este liga lod datos de la auditoria con lo elementos de la lista
    id_auditoria -- llave foranea de la autitoria
    name        VARCHAR --puede se nullo
    version     VARCHAR --puede se nullo
    ILEGAL      VARCHAR --puede se nullo
    fecha       VARCHAR  --puede se nullo


========================================================================================================
esta sql es de una tabla de sqlite podrias generar la migracion el modelo y e controlador de :::  CREATE TABLE BlackList (
    id     INTEGER      NOT NULL
